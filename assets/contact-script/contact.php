...
$from = 'Contact form <contact.shahibshadman@gmail.com>';

// an email address that will receive the email with the output of the form
$sendTo = 'Contact form <shahibshadman@gmail.com>';

// subject of the email
$subject = 'Consultator Template Email';
...
try
{
    ...
    $emailText = "You have a new message from Consultator Template\n====================================\n";
...
// else just display the message
    ...
    header('https://designelit.com/template/cbiz/index.html');
    exit;
}
